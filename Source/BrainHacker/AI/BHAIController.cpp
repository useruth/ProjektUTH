...
#include "BrainHacker/AI/BHAIController.h"

#include "GOAP/BHMemoryComponent.h"
...
void ABHAIController::OnPossess(APawn* NewPawn)
{
	...
	ControlledPawnMemory = Cast<UBHMemoryComponent>(NewPawn->GetComponentByClass(UBHMemoryComponent::StaticClass()));
